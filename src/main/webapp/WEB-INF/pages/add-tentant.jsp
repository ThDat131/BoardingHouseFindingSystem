...
<div class="container">
    ...
    <form:form modelAttribute="tentantuser" method="post" action="${action}"  enctype="multipart/form-data">
        ...
        <div class="form-floating my-3">
            <input type="password" class="form-control" id="rePassword" placeholder="Nhập lại mật khẩu" name="rePassword" path="rePassword"/>
            <label for="rePassword">Nhập lại mật khẩu</label>
            <form:errors path="rePassword" element="div" cssClass="alert alert-danger mt-2" />
        </div>
        <div class="form-floating my-3">
